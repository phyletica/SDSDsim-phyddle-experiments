...
class Priors(object):
    def __init__(
        ...
        burst_prob_1 = st.uniform(0.0, 0.25),
...
def draw_bdb_model(priors, rng):
    ...
    burst_prob_1 = burst_prob_0
    model_type = priors.model.rvs(size = None, random_state = rng)
    if model_type == 1:
    ...
    return model, model_type, root_state
...
def main():
    ...
    while sim_idx < (start_idx + batch_size):
        ...
        model, model_type, root_state = draw_bdb_model(priors, rng)
